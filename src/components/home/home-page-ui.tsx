  ...
  return (
    <div>
      <div className="container relative mx-auto h-[calc(100dvh-120px)] overflow-hidden">
        <div className="space-y- px-5 sm:px-10 sm:py-3 fixed h-[calc(100vh-135px)] sm:h-[calc(100%-150px)]  w-[90%] overflow-y-scroll scrollbar-hide top-[50%] left-1/2 transform -translate-x-1/2 -translate-y-[48%] bg-[#202020] rounded-[10px]">
